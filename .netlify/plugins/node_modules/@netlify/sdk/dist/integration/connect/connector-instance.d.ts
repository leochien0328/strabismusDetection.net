...
export declare class ConfiguredNetlifyConnector {
    ...
    get definedImplementations(): Map<import("./sdk.js").APIName, false | ((args?: any, options?: any) => any)>;
    get isUsingUnifiedAPI(): boolean;
    get supports(): import("./sdk.js").ConnectorSupports;
    shouldHandleCreateSupport(): boolean | undefined;
    ...
    sync(args: SourceNodesArgs): Promise<void>;
    private legacySyncWrapper;
    private legacySync;
    private unifiedSync;
