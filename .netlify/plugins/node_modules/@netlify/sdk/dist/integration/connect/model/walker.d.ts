...
export declare class ModelWalker {
    ...
    get fields(): Fields;
    private visitInputValue;
    coerceModelValue(modelValue: RawNodeObject, path?: string[], combinedType?: ModelDefinition, visitorState?: VisitorState, forPackage?: `content-engine` | `stackbit`): RawNodeObject;
    private setNodeId;
    private handleCrossReferenceValue;
    ...
    private throwOnInvalidEnumValues;
}
export {};
