 ...
 */
export function getAPIPromises(instanceID, apiName, supports) {
    ...
    // if netlify create isn't supported, resolve the promise immediately. this allows us to always await this promise elsewhere
    if (!supports.create) {
