export class Surface {
    ...
    addForm(options, builder) {
        const { title, description, if: _if, display, onSubmit, onCancel, id, saveLabel, cancelLabel, savingLabel, variant, hideCancel, } = options;
        ...
        if (onCancel) {
            this._formCallbacks[id + ":cancel"] = onCancel;
        }
