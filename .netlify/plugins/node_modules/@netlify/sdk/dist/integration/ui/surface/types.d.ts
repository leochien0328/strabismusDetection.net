...
export type CallbackFunc = (state: SurfaceState) => Promise<Partial<SurfaceState>> | Partial<SurfaceState> | Promise<undefined> | undefined;
export type InteractionCallbackFunc = (state: SurfaceState, value: string | number | boolean) => Promise<Partial<SurfaceState>> | Partial<SurfaceState> | Promise<void> | undefined;
