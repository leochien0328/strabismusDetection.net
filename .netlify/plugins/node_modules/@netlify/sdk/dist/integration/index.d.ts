...
import { BaseConnectorLocalDevOptions, ConnectorBaseOptionsSchema, ConnectorConfigInput, ConnectorContextState, ConnectorSupports, type ConnectorDefineOptions, type ConnectorDefineOptionsSchemaOutput, type ConnectorInitState, NetlifyConnector } from "./connect/sdk.js";
...
export declare class NetlifyIntegration<SiteConfigSchema extends z.ZodSchema = z.ZodUnknown, TeamConfigSchema extends z.ZodSchema = z.ZodUnknown, BuildContext extends z.ZodSchema = z.ZodUnknown, BuildConfigSchema extends z.ZodSchema = z.ZodUnknown> {
     ...
     */
    createConnector(_config: ConnectorConfigInput): void;
    /**
