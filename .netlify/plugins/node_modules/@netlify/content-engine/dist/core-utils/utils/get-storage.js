...
var _lmdb = _interopRequireDefault(require("lmdb"));
let LockStatus = exports.LockStatus = /*#__PURE__*/function (LockStatus) {
...
function getDatabaseDir() {
  ...
  return _path.default.join(rootDir, `.cache`, `data`, `core-utils`);
}
