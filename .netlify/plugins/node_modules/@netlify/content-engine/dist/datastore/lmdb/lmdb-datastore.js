...
function getLmdbStore({
  ...
  async function restartDbs() {
    ...
    await Promise.all([dbs.nodes.close(), dbs.nodesByType.close(), dbs.metadata.close(), dbs.indexes.close(), rootDb.close()]);
