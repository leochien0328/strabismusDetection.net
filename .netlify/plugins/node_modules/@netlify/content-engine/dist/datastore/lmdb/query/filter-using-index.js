...
const BinaryInfinityNegative = exports.BinaryInfinityNegative = Buffer.from([0]);
const BinaryInfinityPositive = exports.BinaryInfinityPositive = String.fromCharCode(255).repeat(4);
var ValueEdges = /*#__PURE__*/function (ValueEdges) {
