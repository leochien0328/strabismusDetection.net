...
const findChildren = initialChildren => {
  ...
  while (queue.length > 0) {
    ...
    if ((0, _isArray2.default)(newChildren) && newChildren.length > 0) {
...
actionOptions = {}) => {
  ...
  // @ts-ignore
  if (!node.array && !(0, _isArray2.default)(node.children)) {
    // @ts-ignore
    node.children = [];
  }
...
actions.createNodeField = ({
  ...
  const schemaFieldName = (0, _includes2.default)(name, `___NODE`) ?
  // @ts-ignore
...
actions.setBabelOptions = (options, plugin) => {
  ...
  // @ts-ignore
  if (!(0, _isObject2.default)(options.options)) {
