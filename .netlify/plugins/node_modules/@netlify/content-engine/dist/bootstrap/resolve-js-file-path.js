 ...
 */
const maybeAddFileProtocol = exports.maybeAddFileProtocol = process.env.JEST_WORKER_ID ? module => module : module => (0, _url.pathToFileURL)(module).href;
...
async function resolveJSFilepath({
  ...
  const filePathWithTSExtension = filePath.endsWith(`.ts`) ? filePath : `${filePath}.ts`;
