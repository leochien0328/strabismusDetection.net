...
const fieldNames = {
  query: typeName => (0, _camelCase2.default)(typeName),
  queryAll: typeName => (0, _camelCase2.default)(`all ${typeName}`),
  convenienceChild: typeName => (0, _camelCase2.default)(`child ${typeName}`),
  convenienceChildren: typeName => (0, _camelCase2.default)(`children ${typeName}`)
};
const addTypes = ({
  schemaComposer,
  types,
...
const determineSearchableFields = ({
  ...
  typeComposer.getFieldNames().forEach(fieldName => {
    ...
    if (field.resolve) {
      ...
      } else if (!(0, _isEmpty2.default)(field.args)) {
        typeComposer.extendFieldExtensions(fieldName, {
